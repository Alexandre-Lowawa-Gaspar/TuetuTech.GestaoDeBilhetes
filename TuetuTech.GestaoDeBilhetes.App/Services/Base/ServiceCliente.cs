...
namespace TuetuTech.GestaoDeBilhetes.App.Services
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PagedOrdersForMonthVm> ObterPaginacaoOrdersPorMesAsync(System.DateTimeOffset? date, int? page, int? size)
        {
            return ObterPaginacaoOrdersPorMesAsync(date, page, size, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PagedOrdersForMonthVm> ObterPaginacaoOrdersPorMesAsync(System.DateTimeOffset? date, int? page, int? size, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "ObterPaginacaoOrdersPorMes"
                    urlBuilder_.Append("ObterPaginacaoOrdersPorMes");
                    urlBuilder_.Append('?');
                    if (date != null)
                    {
    ...
    public partial class OrdersForMonthDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("orderOrderTotal", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
